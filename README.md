...
2023 Update: Currently exploring Natural Language Processing using nltk and AI Concepts + Algorithm Design.<br/>
2024 Feb Update: I am now actively looking into Android Application Development with Flutter and Kotlin, while also diving deeper into NextJS's techstack.<br/>
2024 Aug Update: Actively diving into IOS Application Development with SwiftUI and UIKit, while also mastering Fullstack WebDev with NextJS, Golang and Sanity.<br/>
